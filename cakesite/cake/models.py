...
class Cake(models.Model):
    ...
    img2 = models.ImageField("图片2", upload_to="photos/%Y/%m/%d", default="photos/2017/12/01/cart_ico1.png", blank=True, null=True)
    img3 = models.ImageField("图片3", upload_to="photos/%Y/%m/%d", default="photos/2017/12/01/cart_ico1.png", blank=True, null=True)
